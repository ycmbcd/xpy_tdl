...
// 下载统计年报表
if(isset($_POST['down_year'])){
    // 获取年份
    $down_year = addslashes($_POST['down_year']);

    require_once("./PHPExcel/PHPExcel.php");  //引入PHPExcel
    //PHPExcel
    $objPHPExcel = new PHPExcel();
    $objSheet = $objPHPExcel->getActiveSheet();
    $objSheet->setTitle('统计年报表→'.$down_year);//表名
    ...
    $startDate = $down_year.'-01-01';
    $endDate = $down_year.'-12-31';
    ...
    $table_name = 'year_all_table_'.$u_id.'_'.time().'.xlsx';
